...
class Graph:
    ...
    def add_node(self, properties: dict) -> Node:
    ...
    def add_edge(self, tail: Node, label: str, head: Node, properties: dict = {}) -> Edge:
        """ 
    ...
    @staticmethod
    def _match_dict(d1: dict, d2: dict):
        matches = 0
    ...
    def find_node(self, properties: dict) -> Node:
        """
    ...
    def find_node_edges_label_outgoing(self, node: Node, label: str):
        """ 
    ...
    def find_node_edges_label_incoming(self, node: Node, label: str):
        """ 
    ...
    def follow_edge_on_label(self, edge: Edge, label: str):
        """
            Follow edge via head vertex on a specific label,
